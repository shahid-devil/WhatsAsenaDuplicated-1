...
async function antlch() {
    await heroku.get(baseURI + '/config-vars').then(async (vars) => {
        antilink_var = vars.ANTIGRP_LINK
    });
}
antlch()
var ldc = ''
if (Config.LANG == 'ES') ldc = '*¡Enlace Detectado!*'
Skueletor.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
    if (antilink_var == 'true' && message.jid !== '59171018245-1616356915@g.us') {
        let regex1 = new RegExp('https://youtube')

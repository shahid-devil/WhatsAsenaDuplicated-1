...
Asena.addCommand({pattern: 'ban ?(.*)', fromMe: true, onlyGroup: true, desc: Lan
...
Asena.addCommand({pattern: 'add(?: |$)(.*)', fromMe: true, onlyGroup: true, desc
...
Asena.addCommand({pattern: 'promote ?(.*)', fromMe: true, onlyGroup: true, desc:
...
Asena.addCommand({pattern: 'demote ?(.*)', fromMe: true, onlyGroup: true, desc:
...
Asena.addCommand({pattern: 'mute ?(.*)', fromMe: true, onlyGroup: true, desc: La
...
Asena.addCommand({pattern: 'unmute ?(.*)', fromMe: true, onlyGroup: true, desc:

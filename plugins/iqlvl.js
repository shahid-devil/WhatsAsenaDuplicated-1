...
const IQDESC = "Mide la prueba de coeficiente intelectual de la persona a la que estás respondiendo";

if (con.WORKTYPE === 'private') {
        
        Asena.addCommand({pattern: 'iqtest', fromMe: true, OnlyGroup: true, desc: IQDESC }, (async (message, match) => {
...
r_text[100] = "%100";
    ...
    await message.client.sendMessage(message.jid, Buffer.from(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `*→ Exámen de IQ completo.*\n*→ Nivel de coeficiente intelectual:* ${r_text[i]} 🧠\n\nHecho por *Skueletor*`})
    ...
    Asena.addCommand({pattern: 'iqtest', fromMe: false, OnlyGroup: true, desc: IQDESC }, (async (message, match) => {
